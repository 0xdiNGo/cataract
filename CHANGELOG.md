...
- Added development guidelines (`SKILL.md`)
- Added game design document (`docs/GAME_DESIGN.md`)
- Added architecture overview (`ARCHITECTURE.md`)
- Added initial system diagrams
